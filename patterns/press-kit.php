...
<div class="wp-block-group">
    ...
    <h2 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'Press & Media', 'campaign-office' ); ?></h2>
    <!-- /wp:heading -->

    <!-- wp:paragraph {"align":"center"} -->
    <p class="has-text-align-center"><?php esc_html_e( 'Latest press releases and media resources.', 'campaign-office' ); ?></p>
    <!-- /wp:paragraph -->
    ...
    <div class="wp-block-columns">
        ...
        <div class="wp-block-column" style="flex-basis:66%">
            <!-- wp:heading {"level":3} -->
            <h3 class="wp-block-heading"><?php esc_html_e( 'Latest Releases', 'campaign-office' ); ?></h3>
            <!-- /wp:heading -->
        ...
        <div class="wp-block-column has-border-color has-neutral-300-border-color" style="border-width:1px;flex-basis:33%;padding-top:var(--wp--preset--spacing--6);padding-right:var(--wp--preset--spacing--6);padding-bottom:var(--wp--preset--spacing--6);padding-left:var(--wp--preset--spacing--6)">
            <!-- wp:heading {"level":3} -->
            <h3 class="wp-block-heading"><?php esc_html_e( 'Media Kit', 'campaign-office' ); ?></h3>
            <!-- /wp:heading -->

            <!-- wp:file {"showDownloadButton":true,"downloadButtonText":"Download Bio"} -->
            <div class="wp-block-file"><a href="#"><?php esc_html_e( 'Candidate Bio (PDF)', 'campaign-office' ); ?></a><a href="#" class="wp-block-file__button wp-element-button" download><?php esc_html_e( 'Download Bio', 'campaign-office' ); ?></a></div>
            <!-- /wp:file -->

            <!-- wp:file {"showDownloadButton":true,"downloadButtonText":"Download Headshot"} -->
            <div class="wp-block-file"><a href="#"><?php esc_html_e( 'Official Headshot (JPG)', 'campaign-office' ); ?></a><a href="#" class="wp-block-file__button wp-element-button" download><?php esc_html_e( 'Download Headshot', 'campaign-office' ); ?></a></div>
            <!-- /wp:file -->

            <!-- wp:paragraph {"fontSize":"sm","style":{"spacing":{"margin":{"top":"2rem"}}}} -->
            <p class="has-sm-font-size" style="margin-top:2rem"><strong><?php esc_html_e( 'Press Contact:', 'campaign-office' ); ?></strong><br>press@campaign.com<br>555-0123</p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:column -->
    </div>
