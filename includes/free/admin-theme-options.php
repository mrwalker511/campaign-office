...
function campaignpress_add_theme_options_page() {
    add_menu_page(
        __( 'CampaignPress Options', 'campaign-office' ),
        __( 'CampaignPress', 'campaign-office' ),
        'manage_options',
...
function campaignpress_render_theme_options_page() {
    ...
    if ( isset( $_GET['settings-updated'] ) ) {
        add_settings_error(
            ...
            __( 'Settings Saved Successfully!', 'campaign-office' ),
            'updated'
        );
    }
    ...
    <div class="wrap campaignpress-options-wrap">
        <div class="campaignpress-header">
            <div class="campaignpress-header-content">
                ...
                <p class="campaignpress-subtitle"><?php esc_html_e( 'Customize your campaign website', 'campaign-office' ); ?></p>
            </div>
            <div class="campaignpress-header-actions">
                <button type="button" class="button button-secondary campaignpress-reset-btn" onclick="return confirm('<?php esc_attr_e( 'Are you sure you want to reset all settings to defaults?', 'campaign-office' ); ?>');">
                    <span class="dashicons dashicons-image-rotate"></span>
                    <?php esc_html_e( 'Reset to Defaults', 'campaign-office' ); ?>
                </button>
            </div>
        </div>
        ...
        <div class="campaignpress-content">
            <form method="post" action="options.php" class="campaignpress-form">
                ...
                <div class="campaignpress-actions">
                    <?php submit_button( __( 'Save Changes', 'campaign-office' ), 'primary large', 'submit', false ); ?>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="campaignpress-tab-content">
        <div class="campaignpress-section">
            <h2 class="section-title">
                ...
                <?php esc_html_e( 'Campaign Information', 'campaign-office' ); ?>
            </h2>

            <table class="form-table">
                <tr>
                    <th scope="row">
                        <label for="campaignpress_candidate_name"><?php esc_html_e( 'Candidate Name', 'campaign-office' ); ?></label>
                    </th>
                    <td>
                        ...
                        <p class="description"><?php esc_html_e( 'Enter the full name of the candidate', 'campaign-office' ); ?></p>
                    </td>
                </tr>

                <tr>
                    <th scope="row">
                        <label for="campaignpress_office_seeking"><?php esc_html_e( 'Office Seeking', 'campaign-office' ); ?></label>
                    </th>
                    <td>
                        ...
                        <p class="description"><?php esc_html_e( 'e.g., "State Senate District 12" or "City Council"', 'campaign-office' ); ?></p>
                    </td>
                </tr>

                <tr>
                    <th scope="row">
                        <label for="campaignpress_campaign_tagline"><?php esc_html_e( 'Campaign Tagline', 'campaign-office' ); ?></label>
                    </th>
                    <td>
                        ...
                        <p class="description"><?php esc_html_e( 'Your campaign slogan or tagline', 'campaign-office' ); ?></p>
                    </td>
                </tr>

                <tr>
                    <th scope="row">
                        <label for="campaignpress_campaign_year"><?php esc_html_e( 'Campaign Year', 'campaign-office' ); ?></label>
                    </th>
                    <td>
                        ...
                        <p class="description"><?php esc_html_e( 'Year of the election', 'campaign-office' ); ?></p>
                    </td>
                </tr>

                <tr>
                    <th scope="row">
                        <label for="campaignpress_election_date"><?php esc_html_e( 'Election Date', 'campaign-office' ); ?></label>
                    </th>
                    <td>
                        ...
                        <p class="description"><?php esc_html_e( 'Date of the election', 'campaign-office' ); ?></p>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="campaignpress-section">
            <h2 class="section-title">
                ...
                <?php esc_html_e( 'Action URLs', 'campaign-office' ); ?>
            </h2>

            <table class="form-table">
                <tr>
                    <th scope="row">
                        <label for="campaignpress_donation_url"><?php esc_html_e( 'Donation Page URL', 'campaign-office' ); ?></label>
                    </th>
                    <td>
                        ...
                        <p class="description"><?php esc_html_e( 'Link to ActBlue, WinRed, or your donation platform', 'campaign-office' ); ?></p>
                    </td>
                </tr>

                <tr>
                    <th scope="row">
                        <label for="campaignpress_volunteer_url"><?php esc_html_e( 'Volunteer Signup URL', 'campaign-office' ); ?></label>
                    </th>
                    <td>
                        ...
                        <p class="description"><?php esc_html_e( 'Link to volunteer signup form', 'campaign-office' ); ?></p>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div class="campaignpress-tab-content">
        <div class="campaignpress-section">
            <h2 class="section-title">
                ...
                <?php esc_html_e( 'Color Scheme', 'campaign-office' ); ?>
            </h2>

            <table class="form-table">
                <tr>
                    <th scope="row">
                        <label for="campaignpress_color_scheme"><?php esc_html_e( 'Preset Color Scheme', 'campaign-office' ); ?></label>
                    </th>
                    <td>
                        <select id="campaignpress_color_scheme" name="campaignpress_color_scheme" class="regular-text">
                            <option value="democrat-blue" <?php selected( get_option( 'campaignpress_color_scheme', $defaults['campaignpress_color_scheme'] ), 'democrat-blue' ); ?>><?php esc_html_e( 'Democrat Blue', 'campaign-office' ); ?></option>
                            <option value="republican-red" <?php selected( get_option( 'campaignpress_color_scheme' ), 'republican-red' ); ?>><?php esc_html_e( 'Republican Red', 'campaign-office' ); ?></option>
                            <option value="independent-purple" <?php selected( get_option( 'campaignpress_color_scheme' ), 'independent-purple' ); ?>><?php esc_html_e( 'Independent Purple', 'campaign-office' ); ?></option>
                            <option value="green-party" <?php selected( get_option( 'campaignpress_color_scheme' ), 'green-party' ); ?>><?php esc_html_e( 'Green Party', 'campaign-office' ); ?></option>
                            <option value="neutral" <?php selected( get_option( 'campaignpress_color_scheme' ), 'neutral' ); ?>><?php esc_html_e( 'Neutral', 'campaign-office' ); ?></option>
                            <option value="custom" <?php selected( get_option( 'campaignpress_color_scheme' ), 'custom' ); ?>><?php esc_html_e( 'Custom', 'campaign-office' ); ?></option>
                        </select>
                        <p class="description"><?php esc_html_e( 'Choose a preset color scheme or select Custom to use your own colors', 'campaign-office' ); ?></p>
                    </td>
                </tr>

                <tr>
                    <th scope="row">
                        <label for="campaignpress_primary_color"><?php esc_html_e( 'Primary Color', 'campaign-office' ); ?></label>
                    </th>
                    <td>
                        ...
                        <p class="description"><?php esc_html_e( 'Main brand color used for headers, buttons, and accents', 'campaign-office' ); ?></p>
                    </td>
                </tr>

                <tr>
                    <th scope="row">
                        <label for="campaignpress_secondary_color"><?php esc_html_e( 'Secondary Color', 'campaign-office' ); ?></label>
                    </th>
                    <td>
                        ...
                        <p class="description"><?php esc_html_e( 'Secondary color for text and backgrounds', 'campaign-office' ); ?></p>
                    </td>
                </tr>

                <tr>
                    <th scope="row">
                        <label for="campaignpress_accent_color"><?php esc_html_e( 'Accent Color', 'campaign-office' ); ?></label>
                    </th>
                    <td>
                        ...
                        <p class="description"><?php esc_html_e( 'Accent color for call-to-action elements', 'campaign-office' ); ?></p>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="campaignpress-section">
            <h2 class="section-title">
                ...
                <?php esc_html_e( 'Layout Options', 'campaign-office' ); ?>
            </h2>

            <table class="form-table">
                <tr>
                    <th scope="row">
                        <label for="campaignpress_homepage_layout"><?php esc_html_e( 'Homepage Layout', 'campaign-office' ); ?></label>
                    </th>
                    <td>
                        <select id="campaignpress_homepage_layout" name="campaignpress_homepage_layout" class="regular-text">
                            <option value="classic-candidate" <?php selected( get_option( 'campaignpress_homepage_layout', $defaults['campaignpress_homepage_layout'] ), 'classic-candidate' ); ?>><?php esc_html_e( 'Classic Candidate', 'campaign-office' ); ?></option>
                            <option value="modern-progressive" <?php selected( get_option( 'campaignpress_homepage_layout' ), 'modern-progressive' ); ?>><?php esc_html_e( 'Modern Progressive', 'campaign-office' ); ?></option>
                            <option value="conservative-traditional" <?php selected( get_option( 'campaignpress_homepage_layout' ), 'conservative-traditional' ); ?>><?php esc_html_e( 'Conservative Traditional', 'campaign-office' ); ?></option>
                        </select>
                        <p class="description"><?php esc_html_e( 'Choose the homepage layout style', 'campaign-office' ); ?></p>
                    </td>
                </tr>

                <tr>
                    <th scope="row">
                        <label for="campaignpress_layout"><?php esc_html_e( 'Site Layout', 'campaign-office' ); ?></label>
                    </th>
                    <td>
                        <select id="campaignpress_layout" name="campaignpress_layout" class="regular-text">
                            <option value="sidebar-right" <?php selected( get_option( 'campaignpress_layout', $defaults['campaignpress_layout'] ), 'sidebar-right' ); ?>><?php esc_html_e( 'Sidebar Right', 'campaign-office' ); ?></option>
                            <option value="sidebar-left" <?php selected( get_option( 'campaignpress_layout' ), 'sidebar-left' ); ?>><?php esc_html_e( 'Sidebar Left', 'campaign-office' ); ?></option>
                            <option value="no-sidebar" <?php selected( get_option( 'campaignpress_layout' ), 'no-sidebar' ); ?>><?php esc_html_e( 'No Sidebar (Full Width)', 'campaign-office' ); ?></option>
                        </select>
                        <p class="description"><?php esc_html_e( 'Default layout for pages and posts', 'campaign-office' ); ?></p>
                    </td>
                </tr>

                <tr>
                    <th scope="row">
                        <label for="campaignpress_logo_width"><?php esc_html_e( 'Logo Width (px)', 'campaign-office' ); ?></label>
                    </th>
                    <td>
                        ...
                        <p class="description"><?php esc_html_e( 'Maximum width of your logo in pixels', 'campaign-office' ); ?></p>
                    </td>
                </tr>

                <tr>
                    <th scope="row">
                        <label for="campaignpress_enable_sticky_header"><?php esc_html_e( 'Sticky Header', 'campaign-office' ); ?></label>
                    </th>
                    <td>
                        <label>
                            ...
                            <?php esc_html_e( 'Enable sticky header (header stays visible when scrolling)', 'campaign-office' ); ?>
                        </label>
                    </td>
                </tr>
            </table>
        ...
        <div class="campaignpress-section">
            <h2 class="section-title">
                ...
                <?php esc_html_e( 'Hero Video Overlay', 'campaign-office' ); ?>
            </h2>
            <p class="section-description"><?php esc_html_e( 'Set a default video overlay for hero sections. This can be overridden on individual pages.', 'campaign-office' ); ?></p>

            <table class="form-table">
                <tr>
                    <th scope="row">
                        <label for="campaignpress_enable_hero_video"><?php esc_html_e( 'Enable Hero Video', 'campaign-office' ); ?></label>
                    </th>
                    <td>
                        <label>
                            ...
                            <?php esc_html_e( 'Use video overlay for hero sections by default', 'campaign-office' ); ?>
                        </label>
                    </td>
                </tr>
                ...
                <tr>
                    <th scope="row">
                        <label for="campaignpress_hero_video_url"><?php esc_html_e( 'Default Hero Video URL', 'campaign-office' ); ?></label>
                    </th>
                    <td>
                        ...
                        <p class="description"><?php esc_html_e( 'URL to your default hero video. Recommended formats: MP4, WebM. Keep file size under 5MB for best performance.', 'campaign-office' ); ?></p>
                    </td>
                </tr>

                <tr>
                    <th scope="row">
                        <label for="campaignpress_hero_video_type"><?php esc_html_e( 'Video Format', 'campaign-office' ); ?></label>
                    </th>
                    <td>
                        <select id="campaignpress_hero_video_type" name="campaignpress_hero_video_type" class="regular-text">
                            <option value="video/mp4" <?php selected( get_option( 'campaignpress_hero_video_type', 'video/mp4' ), 'video/mp4' ); ?>><?php esc_html_e( 'MP4 (video/mp4)', 'campaign-office' ); ?></option>
                            <option value="video/webm" <?php selected( get_option( 'campaignpress_hero_video_type' ), 'video/webm' ); ?>><?php esc_html_e( 'WebM (video/webm)', 'campaign-office' ); ?></option>
                            <option value="video/ogg" <?php selected( get_option( 'campaignpress_hero_video_type' ), 'video/ogg' ); ?>><?php esc_html_e( 'OGG (video/ogg)', 'campaign-office' ); ?></option>
                        </select>
                        <p class="description"><?php esc_html_e( 'Select the video MIME type that matches your video file format.', 'campaign-office' ); ?></p>
                    </td>
                </tr>
            </table>
            ...
            <div class="notice notice-info inline" style="margin: 20px 0;">
                <p>
                    <strong><?php esc_html_e( 'Note:', 'campaign-office' ); ?></strong>
                    <?php esc_html_e( 'Individual pages can override this default by setting their own video in the "Hero Video Overlay" meta box when editing the page.', 'campaign-office' ); ?>
                </p>
            </div>
        </div>
    </div>
...
function campaignpress_render_typography_tab() {
    ...
    <div class="campaignpress-tab-content">
        <div class="campaignpress-section">
            <h2 class="section-title">
                <span class="dashicons dashicons-editor-textcolor"></span>
                <?php esc_html_e( 'Font Settings', 'campaign-office' ); ?>
            </h2>

            <table class="form-table">
                <tr>
                    <th scope="row">
                        <label for="campaignpress_heading_font"><?php esc_html_e( 'Heading Font', 'campaign-office' ); ?></label>
                    </th>
                    <td>
                        <select id="campaignpress_heading_font" name="campaignpress_heading_font" class="regular-text">
                            <option value="system-ui" <?php selected( get_option( 'campaignpress_heading_font', $defaults['campaignpress_heading_font'] ), 'system-ui' ); ?>><?php esc_html_e( 'System UI (Fast & Modern)', 'campaign-office' ); ?></option>
                            <option value="Georgia, serif" <?php selected( get_option( 'campaignpress_heading_font' ), 'Georgia, serif' ); ?>><?php esc_html_e( 'Georgia (Classic Serif)', 'campaign-office' ); ?></option>
                            <option value="'Times New Roman', serif" <?php selected( get_option( 'campaignpress_heading_font' ), "'Times New Roman', serif" ); ?>><?php esc_html_e( 'Times New Roman (Traditional)', 'campaign-office' ); ?></option>
                            <option value="Arial, sans-serif" <?php selected( get_option( 'campaignpress_heading_font' ), 'Arial, sans-serif' ); ?>><?php esc_html_e( 'Arial (Clean Sans-Serif)', 'campaign-office' ); ?></option>
                            <option value="'Helvetica Neue', sans-serif" <?php selected( get_option( 'campaignpress_heading_font' ), "'Helvetica Neue', sans-serif" ); ?>><?php esc_html_e( 'Helvetica (Professional)', 'campaign-office' ); ?></option>
                            <option value="'Montserrat', sans-serif" <?php selected( get_option( 'campaignpress_heading_font' ), "'Montserrat', sans-serif" ); ?>><?php esc_html_e( 'Montserrat (Bold & Modern)', 'campaign-office' ); ?></option>
                            <option value="'Playfair Display', serif" <?php selected( get_option( 'campaignpress_heading_font' ), "'Playfair Display', serif" ); ?>><?php esc_html_e( 'Playfair Display (Elegant)', 'campaign-office' ); ?></option>
                        </select>
                        <p class="description"><?php esc_html_e( 'Font family for headings (H1, H2, H3, etc.)', 'campaign-office' ); ?></p>
                    </td>
                </tr>

                <tr>
                    <th scope="row">
                        <label for="campaignpress_body_font"><?php esc_html_e( 'Body Font', 'campaign-office' ); ?></label>
                    </th>
                    <td>
                        <select id="campaignpress_body_font" name="campaignpress_body_font" class="regular-text">
                            <option value="system-ui" <?php selected( get_option( 'campaignpress_body_font', $defaults['campaignpress_body_font'] ), 'system-ui' ); ?>><?php esc_html_e( 'System UI (Fast & Modern)', 'campaign-office' ); ?></option>
                            <option value="Georgia, serif" <?php selected( get_option( 'campaignpress_body_font' ), 'Georgia, serif' ); ?>><?php esc_html_e( 'Georgia (Classic Serif)', 'campaign-office' ); ?></option>
                            <option value="Arial, sans-serif" <?php selected( get_option( 'campaignpress_body_font' ), 'Arial, sans-serif' ); ?>><?php esc_html_e( 'Arial (Clean Sans-Serif)', 'campaign-office' ); ?></option>
                            <option value="'Helvetica Neue', sans-serif" <?php selected( get_option( 'campaignpress_body_font' ), "'Helvetica Neue', sans-serif" ); ?>><?php esc_html_e( 'Helvetica (Professional)', 'campaign-office' ); ?></option>
                            <option value="'Open Sans', sans-serif" <?php selected( get_option( 'campaignpress_body_font' ), "'Open Sans', sans-serif" ); ?>><?php esc_html_e( 'Open Sans (Readable)', 'campaign-office' ); ?></option>
                            <option value="'Lato', sans-serif" <?php selected( get_option( 'campaignpress_body_font' ), "'Lato', sans-serif" ); ?>><?php esc_html_e( 'Lato (Friendly)', 'campaign-office' ); ?></option>
                        </select>
                        <p class="description"><?php esc_html_e( 'Font family for body text', 'campaign-office' ); ?></p>
                    </td>
                </tr>

                <tr>
                    <th scope="row">
                        <label for="campaignpress_font_size_base"><?php esc_html_e( 'Base Font Size (px)', 'campaign-office' ); ?></label>
                    </th>
                    <td>
                        ...
                        <p class="description"><?php esc_html_e( 'Base font size in pixels (recommended: 16)', 'campaign-office' ); ?></p>
                    </td>
                </tr>
            </table>
        </div>
...
function campaignpress_render_social_tab() {
    ...
    <div class="campaignpress-tab-content">
        <div class="campaignpress-section">
            <h2 class="section-title">
                <span class="dashicons dashicons-share"></span>
                <?php esc_html_e( 'Social Media Links', 'campaign-office' ); ?>
            </h2>
            <p class="section-description"><?php esc_html_e( 'Add your social media profile URLs. Leave blank to hide icons.', 'campaign-office' ); ?></p>
                ...
                <tr>
                    <th scope="row">
                        <label for="campaignpress_twitter_url">
                            ...
                            <?php esc_html_e( 'Twitter/X', 'campaign-office' ); ?>
                        </label>
                    </th>
                    <td>
                ...
                <tr>
                    <th scope="row">
                        <label for="campaignpress_instagram_url">
                            ...
                            <?php esc_html_e( 'Instagram', 'campaign-office' ); ?>
                        </label>
                    </th>
                    <td>
                ...
                <tr>
                    <th scope="row">
                        <label for="campaignpress_youtube_url">
                            <span class="dashicons dashicons-video-alt3"></span>
                            <?php esc_html_e( 'YouTube', 'campaign-office' ); ?>
                        </label>
                    </th>
                    <td>
                ...
                <tr>
                    <th scope="row">
                        <label for="campaignpress_linkedin_url">
                            ...
                            <?php esc_html_e( 'LinkedIn', 'campaign-office' ); ?>
                        </label>
                    </th>
                    <td>
                ...
                <tr>
                    <th scope="row">
                        <label for="campaignpress_tiktok_url">
                            ...
                            <?php esc_html_e( 'TikTok', 'campaign-office' ); ?>
                        </label>
                    </th>
                    <td>
...
function campaignpress_render_footer_tab() {
    ...
    <div class="campaignpress-tab-content">
        <div class="campaignpress-section">
            <h2 class="section-title">
                <span class="dashicons dashicons-editor-insertmore"></span>
                <?php esc_html_e( 'Footer Settings', 'campaign-office' ); ?>
            </h2>

            <table class="form-table">
                <tr>
                    <th scope="row">
                        <label for="campaignpress_show_footer_widgets"><?php esc_html_e( 'Footer Widgets', 'campaign-office' ); ?></label>
                    </th>
                    <td>
                        <label>
                            ...
                            <?php esc_html_e( 'Show footer widget areas', 'campaign-office' ); ?>
                        </label>
                    </td>
                </tr>
                ...
                <tr>
                    <th scope="row">
                        <label for="campaignpress_footer_text"><?php esc_html_e( 'Footer Text', 'campaign-office' ); ?></label>
                    </th>
                    <td>
                        <?php
                        wp_editor(
                        ...
                        ?>
                        <p class="description"><?php esc_html_e( 'Custom text to display in the footer', 'campaign-office' ); ?></p>
                    </td>
                </tr>

                <tr>
                    <th scope="row">
                        <label for="campaignpress_disclaimer_text"><?php esc_html_e( 'Legal Disclaimer', 'campaign-office' ); ?></label>
                    </th>
                    <td>
                        <?php
                        wp_editor(
                        ...
                        ?>
                        <p class="description"><?php esc_html_e( 'Legal disclaimer required by campaign finance laws (e.g., "Paid for by...")', 'campaign-office' ); ?></p>
                    </td>
                </tr>
            </table>
        </div>
...
function campaignpress_render_advanced_tab() {
    ...
    <div class="campaignpress-tab-content">
        <div class="campaignpress-section">
            <h2 class="section-title">
                <span class="dashicons dashicons-admin-tools"></span>
                <?php esc_html_e( 'Advanced Settings', 'campaign-office' ); ?>
            </h2>

            <table class="form-table">
                <tr>
                    <th scope="row">
                        <label for="campaignpress_custom_css"><?php esc_html_e( 'Custom CSS', 'campaign-office' ); ?></label>
                    </th>
                    <td>
                        ...
                        <p class="description"><?php esc_html_e( 'Add custom CSS to override theme styles', 'campaign-office' ); ?></p>
                    </td>
                </tr>

                <tr>
                    <th scope="row">
                        <label for="campaignpress_google_analytics_id"><?php esc_html_e( 'Google Analytics ID', 'campaign-office' ); ?></label>
                    </th>
                    <td>
                        ...
                        <p class="description"><?php esc_html_e( 'Google Analytics 4 Measurement ID', 'campaign-office' ); ?></p>
                    </td>
                </tr>

                <tr>
                    <th scope="row">
                        <label for="campaignpress_facebook_pixel_id"><?php esc_html_e( 'Facebook Pixel ID', 'campaign-office' ); ?></label>
                    </th>
                    <td>
                        ...
                        <p class="description"><?php esc_html_e( 'Facebook Pixel ID for conversion tracking', 'campaign-office' ); ?></p>
                    </td>
                </tr>

                <tr>
                    <th scope="row">
                        <label for="campaignpress_enable_maintenance_mode"><?php esc_html_e( 'Maintenance Mode', 'campaign-office' ); ?></label>
                    </th>
                    <td>
                        <label>
                            ...
                            <?php esc_html_e( 'Enable maintenance mode (only admins can view the site)', 'campaign-office' ); ?>
                        </label>
                    </td>
                </tr>
            </table>
