...
<div class="wp-block-group alignfull has-white-color has-neutral-900-background-color has-text-color has-background" style="padding-top:0.5rem;padding-bottom:0.5rem">
    ...
    <p class="has-text-color" style="color:var(--wp--preset--color--accent);font-weight:700;text-transform:uppercase"><?php esc_html_e( 'Latest News:', 'campaign-office' ); ?></p>
    <!-- /wp:paragraph -->
    ...
    <p class="has-small-font-size"><a href="#" style="color:inherit"><?php esc_html_e( 'Read More →', 'campaign-office' ); ?></a></p>
    <!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
