...
<div class="wp-block-group alignwide has-primary-900-background-color has-background" style="border-radius:var(--wp--preset--custom--border-radius--xl);padding-top:var(--wp--preset--spacing--8);padding-right:var(--wp--preset--spacing--8);padding-bottom:var(--wp--preset--spacing--8);padding-left:var(--wp--preset--spacing--8)">
    ...
    <h2 class="wp-block-heading has-text-align-center has-text-color" style="color:var(--wp--preset--color--white)"><?php esc_html_e( 'Campaign Goals', 'campaign-office' ); ?></h2>
    <!-- /wp:heading -->
    ...
    <div class="wp-block-columns">
        ...
        <div class="wp-block-column">
            ...
            <p class="has-text-align-center has-text-color" style="color:var(--wp--preset--color--white)"><?php esc_html_e( 'Doors Knocked', 'campaign-office' ); ?></p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:column -->
        ...
        <div class="wp-block-column">
            ...
            <!-- /wp:paragraph -->
            <!-- wp:paragraph {"align":"center","style":{"color":{"text":"var:preset|color|white"}}} -->
            <p class="has-text-align-center has-text-color" style="color:var(--wp--preset--color--white)"><?php esc_html_e( 'Calls Made', 'campaign-office' ); ?></p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:column -->
        ...
        <div class="wp-block-column">
            ...
            <!-- /wp:paragraph -->
            <!-- wp:paragraph {"align":"center","style":{"color":{"text":"var:preset|color|white"}}} -->
            <p class="has-text-align-center has-text-color" style="color:var(--wp--preset--color--white)"><?php esc_html_e( 'Committed', 'campaign-office' ); ?></p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:column -->
    </div>
