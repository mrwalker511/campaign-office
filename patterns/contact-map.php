...
<div class="wp-block-group alignfull cp-map-placeholder">
    ...
    <div class="wp-block-group">
        ...
        <p class="has-text-align-center" style="font-size:1.5rem;font-weight:600"><?php esc_html_e( 'Interactive Map Would Display Here', 'campaignpress' ); ?></p>
        <!-- /wp:paragraph -->
        <!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"0.875rem"}},"textColor":"neutral-500"} -->
        <p class="has-text-align-center has-neutral-500-color has-text-color" style="font-size:0.875rem"><?php esc_html_e( 'Showing office locations across the district', 'campaignpress' ); ?></p>
        <!-- /wp:paragraph -->
    </div>
    <!-- /wp:group -->
</div>
