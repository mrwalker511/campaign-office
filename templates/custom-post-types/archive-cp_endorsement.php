<?php
/**
 * Template for displaying endorsement archive pages
 *
        ...
        <div class="row">
            <div class="col-lg-8">
                <header class="page-header">
                    <h1 class="page-title"><?php _e('Endorsement', 'campaignpress'); ?></h1>
                ...
                <?php else : ?>
                    ...
                    <section class="no-results not-found">
                        ...
                        <div class="page-content">
                            <p><?php _e('No endorsements found.', 'campaignpress'); ?></p>
                        </div>
                    </section>
