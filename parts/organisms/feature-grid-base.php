<?php
/**
 * Layout Module: Feature Grid - Base Version
 * 
 * 3-column responsive grid with card molecules (icon, headline, body, link).
 */
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            <?php foreach ($features as $feature): ?>
                <!-- Card Molecule -->
                <article class="bg-white p-6 md:p-8 rounded-xl border border-neutral-200 shadow-sm">
                    ...
                    <!-- Headline -->
                    <h3 class="text-xl md:text-2xl font-bold text-brand-900 mb-3">
                    ...
                    <a 
                        ...
                        class="inline-flex items-center text-accent-600 font-semibold hover:text-accent-700 transition-colors focus:outline-none focus:ring-2 focus:ring-accent-500 focus:ring-offset-2 rounded"
