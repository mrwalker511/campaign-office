...
<div class="wp-block-group alignfull cp-section cp-section--white has-white-background-color has-background" style="padding-top:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20)">
    ...
    <div class="wp-block-group alignwide" style="margin-bottom:var(--wp--preset--spacing--12)">
        ...
        <p class="has-text-align-center cp-section__label has-secondary-color has-text-color" style="font-size:0.75rem;font-weight:700;letter-spacing:0.15em;text-transform:uppercase"><?php esc_html_e( 'COMMUNITY VOICES', 'campaignpress' ); ?></p>
        <!-- /wp:paragraph -->
        ...
        <h2 class="wp-block-heading has-text-align-center cp-section__title has-display-font-family" style="font-size:2.5rem;font-weight:700"><?php esc_html_e( 'Why We Support Thomas', 'campaignpress' ); ?></h2>
        <!-- /wp:heading -->
    ...
    <div class="wp-block-columns alignwide">
        ...
        <div class="wp-block-column">
            ...
            <div class="wp-block-group cp-testimonial has-neutral-50-background-color has-background" style="border-left-color:var(--wp--preset--color--secondary);border-left-width:4px;padding-top:2.5rem;padding-right:2.5rem;padding-bottom:2.5rem;padding-left:2.5rem">
                ...
                <p class="cp-testimonial__quote has-neutral-700-color has-text-color" style="font-style:italic;line-height:1.8"><?php esc_html_e( 'Thomas actually understands what it's like to meet a payroll. He's the first candidate I've seen who prioritizes our local economy.', 'campaignpress' ); ?></p>
                <!-- /wp:paragraph -->
                ...
                <div class="wp-block-group">
                    ...
                    <div class="wp-block-group">
                        ...
                        <p class="cp-testimonial__author has-primary-color has-text-color" style="margin-bottom:0;font-weight:700"><?php esc_html_e( 'Sarah Jenkins', 'campaignpress' ); ?></p>
                        <!-- /wp:paragraph -->
                        ...
                        <p class="cp-testimonial__role has-neutral-500-color has-text-color" style="font-size:0.75rem;text-transform:uppercase;letter-spacing:0.1em"><?php esc_html_e( 'Small Business Owner', 'campaignpress' ); ?></p>
                        <!-- /wp:paragraph -->
                    </div>
                    <!-- /wp:group -->
                </div>
        ...
        <div class="wp-block-column">
            ...
            <div class="wp-block-group cp-testimonial has-neutral-50-background-color has-background" style="border-left-color:var(--wp--preset--color--secondary);border-left-width:4px;padding-top:2.5rem;padding-right:2.5rem;padding-bottom:2.5rem;padding-left:2.5rem">
                <!-- wp:paragraph {"className":"cp-testimonial__quote","style":{"typography":{"fontStyle":"italic","lineHeight":"1.8"}},"textColor":"neutral-700"} -->
                <p class="cp-testimonial__quote has-neutral-700-color has-text-color" style="font-style:italic;line-height:1.8"><?php esc_html_e( 'As a veteran, I look for leaders with integrity. Thomas has shown time and again that he stands by his word and his country.', 'campaignpress' ); ?></p>
                <!-- /wp:paragraph -->
                ...
                <div class="wp-block-group">
                    ...
                    <div class="wp-block-group">
                        <!-- wp:paragraph {"className":"cp-testimonial__author","style":{"typography":{"fontWeight":"700"},"spacing":{"margin":{"bottom":"0"}}},"textColor":"primary"} -->
                        <p class="cp-testimonial__author has-primary-color has-text-color" style="margin-bottom:0;font-weight:700"><?php esc_html_e( 'Michael Rodriguez', 'campaignpress' ); ?></p>
                        <!-- /wp:paragraph -->
                        <!-- wp:paragraph {"className":"cp-testimonial__role","style":{"typography":{"fontSize":"0.75rem","textTransform":"uppercase","letterSpacing":"0.1em"}},"textColor":"neutral-500"} -->
                        <p class="cp-testimonial__role has-neutral-500-color has-text-color" style="font-size:0.75rem;text-transform:uppercase;letter-spacing:0.1em"><?php esc_html_e( 'Army Veteran', 'campaignpress' ); ?></p>
                        <!-- /wp:paragraph -->
                    </div>
                    <!-- /wp:group -->
                </div>
        ...
        <div class="wp-block-column">
            ...
            <div class="wp-block-group cp-testimonial has-neutral-50-background-color has-background" style="border-left-color:var(--wp--preset--color--secondary);border-left-width:4px;padding-top:2.5rem;padding-right:2.5rem;padding-bottom:2.5rem;padding-left:2.5rem">
                <!-- wp:paragraph {"className":"cp-testimonial__quote","style":{"typography":{"fontStyle":"italic","lineHeight":"1.8"}},"textColor":"neutral-700"} -->
                <p class="cp-testimonial__quote has-neutral-700-color has-text-color" style="font-style:italic;line-height:1.8"><?php esc_html_e( 'His commitment to education and parental rights is exactly what our school district needs. He's a voice for common sense.', 'campaignpress' ); ?></p>
                <!-- /wp:paragraph -->
                ...
                <div class="wp-block-group">
                    ...
                    <div class="wp-block-group">
                        <!-- wp:paragraph {"className":"cp-testimonial__author","style":{"typography":{"fontWeight":"700"},"spacing":{"margin":{"bottom":"0"}}},"textColor":"primary"} -->
                        <p class="cp-testimonial__author has-primary-color has-text-color" style="margin-bottom:0;font-weight:700"><?php esc_html_e( 'Diane Weber', 'campaignpress' ); ?></p>
                        <!-- /wp:paragraph -->
                        <!-- wp:paragraph {"className":"cp-testimonial__role","style":{"typography":{"fontSize":"0.75rem","textTransform":"uppercase","letterSpacing":"0.1em"}},"textColor":"neutral-500"} -->
                        <p class="cp-testimonial__role has-neutral-500-color has-text-color" style="font-size:0.75rem;text-transform:uppercase;letter-spacing:0.1em"><?php esc_html_e( 'Teacher & Parent', 'campaignpress' ); ?></p>
                        <!-- /wp:paragraph -->
                    </div>
                    <!-- /wp:group -->
                </div>
