...
function campaignpress_register_required_plugins() {
     ...
     */
    $config = array(
        'id'           => 'campaignpress',                 // Unique ID for hashing notices
        ...
        'strings'      => array(
            'page_title'                      => __('Install Required & Recommended Plugins', 'campaignpress'),
            'menu_title'                      => __('Install Plugins', 'campaignpress'),
            'installing'                      => __('Installing Plugin: %s', 'campaignpress'),
            'updating'                        => __('Updating Plugin: %s', 'campaignpress'),
            'oops'                            => __('Something went wrong with the plugin API.', 'campaignpress'),
            ...
            'return'                          => __('Return to Required Plugins Installer', 'campaignpress'),
            'plugin_activated'                => __('Plugin activated successfully.', 'campaignpress'),
            'activated_successfully'          => __('The following plugin was activated successfully:', 'campaignpress'),
            'plugin_already_active'           => __('No action taken. Plugin %1$s was already active.', 'campaignpress'),
            'plugin_needs_higher_version'     => __('Plugin not activated. A higher version of %s is needed for CampaignPress. Please update the plugin.', 'campaignpress'),
            'complete'                        => __('All plugins installed and activated successfully. %1$s', 'campaignpress'),
            'dismiss'                         => __('Dismiss this notice', 'campaignpress'),
            'notice_cannot_install_activate'  => __('There are one or more required or recommended plugins to install, update or activate.', 'campaignpress'),
            'contact_admin'                   => __('Please contact the administrator of this site for help.', 'campaignpress'),
