...
<div class="wp-block-group alignfull has-neutral-100-background-color has-background" style="padding-top:var(--wp--preset--spacing--12);padding-bottom:var(--wp--preset--spacing--12)">
    ...
    <div class="wp-block-columns">
        <!-- wp:column {"style":{"border":{"width":"1px","radius":"var:preset|custom|borderRadius|lg"},"spacing":{"padding":{"top":"var:preset|spacing|6","right":"var:preset|spacing|6","bottom":"var:preset|spacing|6","left":"var:preset|spacing|6"}}},"borderColor":"neutral-300","backgroundColor":"white"} -->
        <div class="wp-block-column has-border-color has-neutral-300-border-color has-white-background-color has-background" style="border-width:1px;border-radius:var(--wp--preset--custom--border-radius--lg);padding-top:var(--wp--preset--spacing--6);padding-right:var(--wp--preset--spacing--6);padding-bottom:var(--wp--preset--spacing--6);padding-left:var(--wp--preset--spacing--6)">
        ...
        <!-- wp:column {"style":{"border":{"width":"2px","radius":"var:preset|custom|borderRadius|lg"},"spacing":{"padding":{"top":"var:preset|spacing|6","right":"var:preset|spacing|6","bottom":"var:preset|spacing|6","left":"var:preset|spacing|6"}}},"borderColor":"primary","backgroundColor":"white"} -->
        <div class="wp-block-column has-border-color has-primary-border-color has-white-background-color has-background" style="border-width:2px;border-radius:var(--wp--preset--custom--border-radius--lg);padding-top:var(--wp--preset--spacing--6);padding-right:var(--wp--preset--spacing--6);padding-bottom:var(--wp--preset--spacing--6);padding-left:var(--wp--preset--spacing--6)">
            <!-- wp:heading {"textAlign":"center","level":3,"style":{"color":{"text":"var:preset|color|primary"}}} -->
