...
<div class="wp-block-group alignfull has-white-color has-secondary-background-color has-text-color has-background" style="border-top-color:rgba(0,0,0,0.1);border-top-width:1px;padding-top:var(--wp--preset--spacing--16);padding-bottom:var(--wp--preset--spacing--16)">
    ...
    <div class="wp-block-group alignwide">
        ...
        <h2 class="wp-block-heading has-text-align-center has-display-font-family" style="font-size:2.5rem;font-weight:700"><?php esc_html_e( 'America is Counting on You', 'campaign-office' ); ?></h2>
        <!-- /wp:heading -->

        <!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"1.25rem","fontWeight":"400"}}} -->
        <p class="has-text-align-center" style="font-size:1.25rem;font-weight:400;max-width:800px;margin-left:auto;margin-right:auto"><?php esc_html_e( 'We can’t do this alone. It takes a movement of dedicated citizens to bring real change. Join us today.', 'campaign-office' ); ?></p>
        <!-- /wp:paragraph -->
        ...
        <div class="wp-block-group" style="margin-top:1rem">
            ...
            <div class="wp-block-group has-white-background-color has-background" style="border-radius:0;padding-top:1rem;padding-right:1.5rem;padding-bottom:1rem;padding-left:1.5rem">
                ...
                <p class="has-neutral-800-color has-text-color" style="font-size:1.25rem;font-weight:700"><?php esc_html_e( '25', 'campaign-office' ); ?></p>
                <!-- /wp:paragraph -->
            </div>
            <!-- /wp:group -->
            ...
            <div class="wp-block-button"><a class="wp-block-button__link has-primary-background-color has-background wp-element-button" style="border-radius:0;padding-top:1.25rem;padding-right:2.5rem;padding-bottom:1.25rem;padding-left:2.5rem;font-weight:700"><?php esc_html_e( 'Donate Now', 'campaign-office' ); ?></a></div>
            <!-- /wp:button -->
        </div>
        <!-- /wp:group -->

        <!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"0.875rem"}},"textColor":"white"} -->
        <p class="has-text-align-center has-white-color has-text-color" style="font-size:0.875rem"><a href="#" style="color:inherit"><?php esc_html_e( 'Donate $50', 'campaign-office' ); ?></a> | <a href="#" style="color:inherit"><?php esc_html_e( 'Donate $100', 'campaign-office' ); ?></a> | <a href="#" style="color:inherit"><?php esc_html_e( 'Donate $250', 'campaign-office' ); ?></a></p>
        <!-- /wp:paragraph -->
    </div>
    <!-- /wp:group -->
</div>
