...
<div class="wp-block-group alignfull cp-section cp-section--white has-white-background-color has-background" style="padding-top:var(--wp--preset--spacing--16);padding-bottom:var(--wp--preset--spacing--16)">
    ...
    <div class="wp-block-group alignwide" style="margin-bottom:var(--wp--preset--spacing--10)">
        ...
        <p class="has-text-align-center cp-section__label has-secondary-color has-text-color" style="font-size:0.75rem;font-weight:700;letter-spacing:0.15em;text-transform:uppercase"><?php esc_html_e( 'Our Core Principles', 'campaign-office' ); ?></p>
        <!-- /wp:paragraph -->

        <!-- wp:heading {"textAlign":"center","level":2,"className":"cp-section__title","fontFamily":"display"} -->
        <h2 class="wp-block-heading has-text-align-center cp-section__title has-display-font-family"><?php esc_html_e( 'Values That Define Us', 'campaign-office' ); ?></h2>
        <!-- /wp:heading -->
    ...
    <div class="wp-block-columns alignwide">
        ...
        <div class="wp-block-column">
            ...
            <div class="wp-block-group cp-card has-neutral-50-background-color has-background" style="border-top-color:var(--wp--preset--color--primary);border-top-width:4px;padding-top:2.5rem;padding-right:2.5rem;padding-bottom:2.5rem;padding-left:2.5rem">
                ...
                <h3 class="wp-block-heading cp-card__title has-display-font-family"><?php esc_html_e( 'Individual Liberty', 'campaign-office' ); ?></h3>
                <!-- /wp:heading -->
                <!-- wp:paragraph {"className":"cp-card__text","textColor":"neutral-600"} -->
                <p class="cp-card__text has-neutral-600-color has-text-color"><?php esc_html_e( 'Defending our constitutional rights against government overreach and preserving freedom for future generations.', 'campaign-office' ); ?></p>
                <!-- /wp:paragraph -->
            </div>
            <!-- /wp:group -->
        </div>
        ...
        <div class="wp-block-column">
            ...
            <div class="wp-block-group cp-card has-neutral-50-background-color has-background" style="border-top-color:var(--wp--preset--color--primary);border-top-width:4px;padding-top:2.5rem;padding-right:2.5rem;padding-bottom:2.5rem;padding-left:2.5rem">
                <!-- wp:heading {"level":3,"className":"cp-card__title","fontFamily":"display"} -->
                <h3 class="wp-block-heading cp-card__title has-display-font-family"><?php esc_html_e( 'Economic Opportunity', 'campaign-office' ); ?></h3>
                <!-- /wp:heading -->
                <!-- wp:paragraph {"className":"cp-card__text","textColor":"neutral-600"} -->
                <p class="cp-card__text has-neutral-600-color has-text-color"><?php esc_html_e( 'Cutting red tape, lowering taxes, and empowering small businesses to create jobs and drive innovation.', 'campaign-office' ); ?></p>
                <!-- /wp:paragraph -->
            </div>
            <!-- /wp:group -->
        </div>
        ...
        <div class="wp-block-column">
            ...
            <div class="wp-block-group cp-card has-neutral-50-background-color has-background" style="border-top-color:var(--wp--preset--color--primary);border-top-width:4px;padding-top:2.5rem;padding-right:2.5rem;padding-bottom:2.5rem;padding-left:2.5rem">
                <!-- wp:heading {"level":3,"className":"cp-card__title","fontFamily":"display"} -->
                <h3 class="wp-block-heading cp-card__title has-display-font-family"><?php esc_html_e( 'Strong Families', 'campaign-office' ); ?></h3>
                <!-- /wp:heading -->
                <!-- wp:paragraph {"className":"cp-card__text","textColor":"neutral-600"} -->
                <p class="cp-card__text has-neutral-600-color has-text-color"><?php esc_html_e( 'Protecting parental rights and ensuring our education system focuses on excellence, not indoctrination.', 'campaign-office' ); ?></p>
                <!-- /wp:paragraph -->
            </div>
            <!-- /wp:group -->
        </div>
