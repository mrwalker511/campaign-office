...
<div class="wp-block-group alignwide has-white-color has-primary-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--8);padding-right:var(--wp--preset--spacing--8);padding-bottom:var(--wp--preset--spacing--8);padding-left:var(--wp--preset--spacing--8)">
    ...
    <h2 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'Election Day Countdown', 'campaign-office' ); ?></h2>
    <!-- /wp:heading -->
    ...
    <div class="wp-block-columns">
        ...
        <div class="wp-block-column">
            ...
            <p class="has-text-align-center has-sm-font-size" style="text-transform:uppercase"><?php esc_html_e( 'Days', 'campaign-office' ); ?></p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:column -->
        ...
        <div class="wp-block-column">
            ...
            <!-- /wp:paragraph -->
             <!-- wp:paragraph {"align":"center","style":{"typography":{"textTransform":"uppercase","fontSize":"sm"}}} -->
            <p class="has-text-align-center has-sm-font-size" style="text-transform:uppercase"><?php esc_html_e( 'Hours', 'campaign-office' ); ?></p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:column -->
        ...
        <div class="wp-block-column">
            ...
            <!-- /wp:paragraph -->
             <!-- wp:paragraph {"align":"center","style":{"typography":{"textTransform":"uppercase","fontSize":"sm"}}} -->
            <p class="has-text-align-center has-sm-font-size" style="text-transform:uppercase"><?php esc_html_e( 'Minutes', 'campaign-office' ); ?></p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:column -->
    </div>
